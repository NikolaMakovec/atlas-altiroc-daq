def getDACList(board):
    ...
    if board==2:
        ...
        dacList[(13,15,0)]=366#3,0.96,ok 
        dacList[(13,16,0)]=312#3,0.94,ok 
        dacList[(13,17,0)]=368#3,0.95,ok 
        dacList[(13,18,0)]=352#3,0.96,ok 
        #dacList[(13,19,0)]=99#3,0.00,ok
        #dacList[(13,20,0)]=334#3,0.98,ok 
        dacList[(13,21,0)]=332#3,0.98,ok 
        dacList[(13,22,0)]=402#3,1.00,ok
        dacList[(13,23,0)]=374#3,1.00,ok
    elif board==14:
