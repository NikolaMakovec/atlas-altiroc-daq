def getDACList(board):
    ...
    if board==2:
        ...
        # dacList[(21,0,2)]=286#3,0.97,ok 
        # dacList[(21,10,2)]=254#3,0.83,ok 
        # dacList[(21,12,2)]=264#3,0.72,PRB!!!!!!!!! 
        # dacList[(21,13,2)]=372#3,0.96,ok 
        # dacList[(21,14,2)]=294#3,0.97,ok 
        # dacList[(21,15,2)]=286#3,0.82,ok 
        # dacList[(21,17,2)]=362#3,0.73,PRB!!!!!!!!! 
        # dacList[(21,18,2)]=348#3,0.82,ok 
        # dacList[(21,19,2)]=354#3,0.93,ok 
        # dacList[(21,1,2)]=336#3,0.76,PRB!!!!!!!!! 
        # dacList[(21,24,2)]=300#3,0.96,ok 
        # dacList[(21,2,2)]=322#3,0.86,ok 
        # dacList[(21,3,2)]=316#3,1.00,ok 
        # dacList[(21,4,2)]=314#3,0.98,ok 
        # dacList[(21,5,2)]=312#3,0.82,ok 
        # dacList[(21,7,2)]=314#3,0.84,ok 
        # dacList[(21,8,2)]=320#3,0.98,ok 
        # dacList[(21,9,2)]=344#3,0.99,ok 
        
        # dacList[(21,0,4)]=282#3,0.89,ok 
        dacList[(21,1,4)]=330#3,0.90,ok 
        dacList[(21,2,4)]=314#3,0.84,ok 
        dacList[(21,3,4)]=310#3,0.97,ok 
        dacList[(21,4,4)]=300#3,1.00,ok 
        dacList[(21,5,4)]=304#3,0.98,ok 
        #dacList[(21,6,4)]=270#3,0.97,ok 
        dacList[(21,7,4)]=308#3,0.92,ok 
        dacList[(21,8,4)]=310#3,0.98,ok 
        dacList[(21,9,4)]=328#3,0.93,ok 
        dacList[(21,10,4)]=250#3,0.87,ok 
        #dacList[(21,11,4)]=302#3,0.79,PRB!!!!!!!!! 
        dacList[(21,12,4)]=260#3,0.68,PRB!!!!!!!!! 
        dacList[(21,13,4)]=354#3,0.95,ok 
        dacList[(21,14,4)]=288#3,0.91,ok 
        dacList[(21,15,4)]=282#3,0.81,ok         
        #dacList[(21,16,4)]=1022#3,1.00,ok 
