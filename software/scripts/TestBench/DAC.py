def getDACList(board):
    ...
    if board==2:
        ...
        dacList[(21,0,4)]=284#4,0.02,PRB!!!!!!!!! 
        dacList[(21,1,4)]=334#4,0.01,PRB!!!!!!!!! 
        dacList[(21,2,4)]=320#4,0.06,PRB!!!!!!!!! 
        dacList[(21,3,4)]=312#4,0.24,PRB!!!!!!!!! 
        dacList[(21,4,4)]=308#4,0.01,PRB!!!!!!!!! 
        dacList[(21,5,4)]=308#4,0.13,PRB!!!!!!!!! 
        dacList[(21,7,4)]=310#4,0.17,PRB!!!!!!!!! 
        dacList[(21,8,4)]=314#4,0.05,PRB!!!!!!!!! 
        dacList[(21,9,4)]=332#4,0.01,PRB!!!!!!!!! 
        dacList[(21,10,4)]=270
        dacList[(21,12,4)]=280
        dacList[(21,13,4)]=364#4,0.01,PRB!!!!!!!!! 
        dacList[(21,14,4)]=294#4,0.01,PRB!!!!!!!!! 
        dacList[(21,15,4)]=284#4,0.06,PRB!!!!!!!!! 
        dacList[(21,17,4)]=354#4,0.01,PRB!!!!!!!!! 
        dacList[(21,18,4)]=342#4,0.03,PRB!!!!!!!!! 
        dacList[(21,19,4)]=352#4,0.01,PRB!!!!!!!!!
        dacList[(21,20,4)]=356#4,0.06,PRB!!!!!!!!! 
        dacList[(21,22,4)]=436#4,0.01,PRB!!!!!!!!! 
        dacList[(21,23,4)]=318#4,0.01,PRB!!!!!!!!! 
        dacList[(21,24,4)]=308#4,0.08,PRB!!!!!!!!!




        dacList[(21,0,4)]=276#3,0.20,PRB!!!!!!!!! 
        dacList[(21,1,4)]=322#3,0.03,PRB!!!!!!!!! 
        dacList[(21,2,4)]=310#3,0.02,PRB!!!!!!!!! 
        dacList[(21,3,4)]=306#3,0.04,PRB!!!!!!!!! 
        dacList[(21,4,4)]=298#3,0.04,PRB!!!!!!!!!
    return dacList                       
