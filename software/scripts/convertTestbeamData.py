...
def parse_arguments():
    ...
    parser.add_argument("-f","--infile", nargs ='+',required = True, help = "input files")
    parser.add_argument("-b","--boards", nargs ='+', required = False, help = "Which ASIC Board(s) was used in this test",default="XX")
